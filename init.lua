...
-- Read this for explanation of these settings https://arisweedler.medium.com/tab-settings-in-vim-1ea0863c5990
...
require('lazy').setup(
  ...
  }, -- end of list of packages sent to Lazy setup
  {
    ui = {
...
-- Vimtex needs syntax coloring for some functionality involving the $ math groups
-- This turns off treesitter, which interferes with this
